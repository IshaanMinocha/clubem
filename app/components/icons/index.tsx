...
export function PlatformIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function ProcessIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
export function ExcelIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8l-6-6zM9.5 17h-1l-2-3.5L4.5 17h-1l2.5-4L3.5 9h1l2 3.5L8.5 9h1l-2.5 4 2.5 4zm4.5 0h-3v-1h2v-2h-2v-1h2v-2h-2V9h3v8zm0-10h-1V3l4 4h-3z" />
    </svg>
  );
}

export function SheetIcon({ className = 'w-5 h-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
